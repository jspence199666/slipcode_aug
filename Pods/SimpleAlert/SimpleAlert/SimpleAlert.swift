...
open class SimpleAlert {
    ...
    open class Controller: UIViewController {
        ...
        @IBOutlet fileprivate weak var contentView: ContentView?
        ...
        open fileprivate(set) var actions: [Action] = []
        ...
        public override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
            ...
            NotificationCenter.default.addObserver(self, selector: #selector(Controller.keyboardWillShow(_:)), name: NSNotification.Name.UIKeyboardWillShow, object: nil)
            NotificationCenter.default.addObserver(self, selector: #selector(Controller.keyboardDidHide(_:)), name: NSNotification.Name.UIKeyboardDidHide, object: nil)
        }
        ...
        open func addAction(_ action: Action) {
            ...
            button.addTarget(self, action: #selector(Controller.buttonWasTapped(_:)), for: .touchUpInside)
